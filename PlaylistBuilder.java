...
public class PlaylistBuilder {
    ...
    public static void main(String[] args) {
        ...
        // ============================================
        Map<String, Integer> songCount = new HashMap<>();  // REPLACE WITH: new HashMap<>()
        // ============================================
        ...
        System.out.println("Found " + songCount.size() + " unique songs across " + totalPlayCount + " plays.");
        ...
        // ============================================
        List<Map.Entry<String, Integer>> unSortedSongs = new ArrayList<>(songCount.entrySet());  // YOUR CODE HERE
        List<Map.Entry<String, Integer>> sortedSongs = new ArrayList<>();  // YOUR CODE HERE
        // ============================================
        String filename = null;
        if(choice == 1){
            filename = "playlist_least_played.txt";
            unSortedSongs.stream().sorted((e1, e2) -> e1.getValue().compareTo(e2.getValue()))
            .forEach(e -> sortedSongs.add(e));
            System.out.println("\nCreating " + filename + "...");
        }
        if(choice == 2){
            filename = "playlist_most_played.txt";
            unSortedSongs.stream().sorted((e1, e2) -> e2.getValue().compareTo(e1.getValue()))
            .forEach(e -> sortedSongs.add(e));
            System.out.println("\nCreating " + filename + "...");
        }
